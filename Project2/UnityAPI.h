...
typedef void (*RecvCallback)(int tick);
...
EXPORT_DLL void UnityAPI_GetRecvData(void *p_data,int len);
/*
 *
 * 设置回调 回调给上层char* buffer和数据的长度
 * */
EXPORT_DLL int UnityAPI_SetRecvDataCallback(RecvCallback callback);
